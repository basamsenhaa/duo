    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "acecwply" in url:
                ...
                url = f"https://covercel.vercel.app/extract_keys?url={url}@bots_updatee&user_id=6834250190"
                ...
                signed_api = f"https://covercel.vercel.app/extract_keys?url={url}@bots_updatee&user_id=6834250190"
            ...
            try:
                if raw_text5 == "yes":
                    ...
                    cc1 = f'[📚]Pdf Id : {str(count).zfill(3)}\n**File Title :** `{v_name}🌟{CR}.pdf`\n\n<blockquote><b>📚 Course Name : {b_name}\nTopic Name : ⋅ ─ ✨ {t_name} ✨ ─ ⋅</b></blockquote>\n\n**🌟 Download By : **{CR}\n'
                    ...
                    cczip = f'[📁]Zip Id : {str(count).zfill(3)}\n**Zip Title :** `{name1}🌟{CR}.zip`\n\n<blockquote><b>📚 Course Name :</b> {b_name}</blockquote>\n\n**🌟 Download By : **{CR}\n' 
                    ccimg = f'[🖼️]Img Id : {str(count).zfill(3)}\n**Img Title :** `{name1}🌟{CR}.jpg`\n\n<blockquote><b>📚 Course Name :</b> {b_name}</blockquote>\n\n**🌟 Download By : **{CR}\n'
                    ccm = f'[🎵]Audio Id : {str(count).zfill(3)}\n**Audio Title :** `{name1}🌟{CR}.mp3`\n\n<blockquote><b>📚 Course Name :</b> {b_name}</blockquote>\n\n**🌟 Download By : **{CR}\n'
                    cchtml = f'[🌐]Html Id : {str(count).zfill(3)}\n**Html Title :** `{name1}🌟{CR}.html`\n\n<blockquote><b>📚 Course Name :</b> {b_name}</blockquote>\n\n**🌟 Download By : **{CR}\n'
